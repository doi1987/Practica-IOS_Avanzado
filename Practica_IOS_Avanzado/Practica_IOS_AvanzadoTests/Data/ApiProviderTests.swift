...
//			
//			let expectedAuthorization = "Bearer \(self.token)"
...
//		}
//		
//		let expectation = expectation(description: "Load Locations for a hero")
//		
//		sut.getLocationsForHeroWith(id: idHero) { result in
//			expectation.fulfill()
//			switch result {
...
//				XCTAssertEqual(locations.count, 18)
//			case .failure( _):
//				XCTFail("expected success")
//			}
//		}
...
//			let path = Bundle(for: type(of: self)).path(forResource: "locations", ofType: "json")!
//			let data = try! Data(contentsOf: URL(filePath: path))
//			let response = MockURLProtocol.urlResponseTest(url: url, statusCode: 401)!
//			return (response, data)
//		}
//		
//		let expectation = expectation(description: "Load Heroes")
...
//				XCTFail("expected failure")
//			case .failure( let error):
//				XCTAssertEqual(error.description, "Failed request with status code 401")
//			}
//		}
//		wait(for: [expectation], timeout: 0.1)
//		
...
//	
//	
//	func testTransformationsSuccess() {
//		let expectedTransformation = Transformation(id: "17824501-1106-4815-BC7A-BFDCCEE43CC9", 
//													name: "1. Oozaru – Gran Mono",
//													description: "Cómo todos los Saiyans con cola, Goku es capaz",
//													photo: "https://areajugones.sport.es/wp-content/uploads/2021/05/ozarru.jpg.webp",
//													hero: nil)
//		
//		self.setToken()
...
//		}
//		
//		let expectation = expectation(description: "Load Transformations for a hero")
//		
//		sut.getTransformationsForHeroWith(id: idHero) { result in
//			expectation.fulfill()
//			switch result {
...
//				XCTAssertTrue(transformation!.description!.contains(expectedTransformation.description!) )
...
//	
//	
//	func testTransformationsFail() {
//		self.setToken()
//		MockURLProtocol.requestHandler = { request in
//			let url = URL(string: "https://dragonball.keepcoding.education/api/heros/transformations")!
//			let path = Bundle(for: type(of: self)).path(forResource: "locations", ofType: "json")!
//			let data = try! Data(contentsOf: URL(filePath: path))
//			let response = MockURLProtocol.urlResponseTest(url: url, statusCode: 401)!
//			return (response, data)
